...
WORDING : Dict[str, Any] =\
{
	...
	'uis':
	{
		...
		'execution_queue_count_slider': '队列计数',
		'execution_thread_count_slider': '线程计数',
		...
		'face_landmarker_model_dropdown': '人脸地标模型',
		'face_landmarker_score_slider': '人脸地标评分',
		'face_mask_blur_slider': '人脸遮罩模糊',
		'face_mask_padding_bottom_slider': '面部遮罩底部',
		'face_mask_padding_left_slider': '面部遮罩左边',
		'face_mask_padding_right_slider': '面部遮罩右边',
		'face_mask_padding_top_slider': '面部遮罩顶部',
		'face_mask_regions_checkbox_group': '遮罩区域',
		'face_mask_types_checkbox_group': '人脸遮罩类型',
		'face_selector_age_range_slider': '年龄选择',
		'face_selector_gender_dropdown': '性别选择',
		'face_selector_mode_dropdown': '人脸选择模式',
		'face_selector_order_dropdown': '顺序选择',
		'face_selector_race_dropdown': '种族选择',
